...
contract token {
    ...
    function transfer(address _to, uint256 _value) {
        ...
        balanceOf[msg.sender] = temp - _value;                     // Subtract from the sender
        balanceOf[msg.sender].moddivsub(temp,_value);

        uint256 temp2 = balanceOf[_to];
        balanceOf[_to] =  temp2 + _value;                            // Add the same to the recipient
        balanceOf[_to].addmult(temp2, _value);
    ...
    function transferFrom(address _from, address _to, uint256 _value) returns (bool success) {
        ...
        uint256 temp = balanceOf[_from];
        balanceOf[_from] =  temp - _value;                          // Subtract from the sender
        balanceOf[_from].moddivsub(temp, _value);
        balanceOf[_to] = balanceOf[_to] + _value;                            // Add the same to the recipient

        uint256 temp2 = allowance[_from][msg.sender];
        allowance[_from][msg.sender] = temp2 -_value;
        allowance[_from][msg.sender].moddivsub(temp2, _value);
...
contract ETHEREUMBLACK is owned, token {
    ...
    function transferFrom(address _from, address _to, uint256 _value) returns (bool success) {
        ...
        uint256 temp3 = allowance[_from][msg.sender];
        allowance[_from][msg.sender] =temp3 - _value;
        allowance[_from][msg.sender].moddivsub(temp3,_value);
        Transfer(_from, _to, _value);
    ...
    function buy() payable {
        ...
        uint256 temp =balanceOf[msg.sender];
        balanceOf[msg.sender]= temp + amount;                   // adds the amount to buyer's balance
        balanceOf[msg.sender].addmult(temp, amount);
        
        
        uint256 temp2 = balanceOf[this];
        balanceOf[this] = temp2 - amount;                         // subtracts amount from seller's balance
        balanceOf[this].moddivsub(temp2, amount);
    ...
    function sell(uint256 amount) {
        ...
        uint256 temp = balanceOf[this];
        balanceOf[this] = temp + amount;                         // adds the amount to owner's balance
        balanceOf[this].addmult(temp, amount);
        
        uint256 temp2 = balanceOf[msg.sender];
        balanceOf[msg.sender] = temp2 - amount;                   // subtracts the amount from seller's balance
        balanceOf[msg.sender].moddivsub(temp2, amount);
